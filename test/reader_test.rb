...
class ReaderTest < Minitest::Test
  ...
  def test_smpl_chunk
    ...
    assert_equal(0, reader.sample_info.sampler_data_size)
    ...
    assert_equal(0, reader.sample_info.loops[0].start_sample_frame)
    assert_equal(0, reader.sample_info.loops[0].end_sample_frame)
